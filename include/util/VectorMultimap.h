...
#ifndef DAGUI_VECTORMULTIMAP_H
#define DAGUI_VECTORMULTIMAP_H
...
namespace dagbase
{
    ...
    public:
        ...
        {
            auto p = std::equal_range(_map.begin(), _map.end(), value_type(key,Value()), _cmp);
//            if (it != _map.end())
//            {
//                if (_eq(it->first, key))
//                {
