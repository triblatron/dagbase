...
INSTANTIATE_TEST_SUITE_P(VectorMultimap, VectorMultimap_testEqualRange, ::testing::Values(
    ...
    std::make_tuple("root = { elements={ {2,1}, {1,1}, {1,2}, {2,2}, {3,1}, {2,3} }, search=2, results={{2,1},{2,3},{2,2}}, op=1 }"),
    std::make_tuple("root = { elements={ {2,1}, {1,1}, {1,2}, {2,2}, {3,1}, {2,3} }, search=2, results={{2,1},{2,3},{2,2}}, op=2 }"),
